...
final appBarText = _text.copyWith(fontSize: 18, fontWeight: FontWeight.w500);
final titleText2 = _text.copyWith(fontSize: 25, fontWeight: FontWeight.bold);

final textReg14 = _text.copyWith(fontSize: 14);

final textReg15 = _text.copyWith(fontSize: 14, fontWeight: FontWeight.w400);
final textReg15bold = _text.copyWith(fontSize: 15, fontWeight: FontWeight.w700);

final textReg16bold = _text.copyWith(fontSize: 16, fontWeight: FontWeight.w500);
